...
<div class="posts-list">
  <ul>
    ...
    <li>
      <a href="./deepseek-replace-copilot">💰 在 VS Code 里免费使用 DeepSeek 替代 Copilot</a>
      <br><small>详细配置教程，月费 ¥3 vs $10 · 07-16</small>
    </li>
    <li>
      <a href="./deepseek-vs-claude-react">⚔️ 同题对比：让 DeepSeek 和 Claude 写同一个 React 组件</a>
      <br><small>同一需求两个模型，从代码质量到工程细节全面对比 · 07-16</small>
    </li>
    <li>
